...
#' @param seeding Either `NULL` (the default) or a matrix generated using [defineSeeds()] function, specifying the location of the centroids to be used to define radially constrained regions. If `NULL`, each unique populated site within `dataMat` will be assessed for viability as the center of a radially constrained region.
